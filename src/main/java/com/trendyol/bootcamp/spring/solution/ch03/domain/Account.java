package com.trendyol.bootcamp.spring.solution.ch03.domain;
...
public class Account extends Entity {
	...
	private Set<AccountContribution.Distribution> distribute(MonetaryAmount amount) {
		Set<AccountContribution.Distribution> distributions = new HashSet<AccountContribution.Distribution>(beneficiaries.size());
		for (Beneficiary beneficiary : beneficiaries) {
			...
			AccountContribution.Distribution distribution = new AccountContribution.Distribution(beneficiary.getName(), distributionAmount, beneficiary
